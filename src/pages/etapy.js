...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section
			background="rgba(255, 127, 98, 0.9)"
			position="fixed"
			display="flex"
			top="56px"
			nout-left="0px"
			...
			<Stack width="100%" lg-flex-direction="column">
				...
				<StackItem width="50%" display="flex" lg-width="100%">
					...
					<Text
						...
						nout-width="100%"
						sm-font="normal 700 42px/1.5 --fontFamily-serifGeorgia"
...
работу сайта на различных устройствах
 ...
 товары, услуги и т.п.)
		...
		<Section background="url(https://uploads.quarkly.io/5f82df518a25ab001e4e7775/images/full_cGxZspFm.png?v=2020-10-18T11:36:05.781Z) top center scroll,linear-gradient(315deg,#FF7F62 0,#262af3 100%)" padding="0px 0 0px 0" height="100vh">
